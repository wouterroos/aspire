...
public partial class TurbineFluentDataGridHeaderCell<T> : ComponentBase
{
    [Parameter]
...
internal static class TurbineFluentDataGridHeaderCell
{
    public static RenderFragment<ColumnBase<T>> RenderHeaderContent<T>(FluentDataGrid<T>? grid)
    {
        ...
        {
            builder.OpenComponent<TurbineFluentDataGridHeaderCell<T>>(0);
            builder.AddAttribute(1, nameof(TurbineFluentDataGridHeaderCell<T>.Column), value);
            builder.AddAttribute(2, nameof(TurbineFluentDataGridHeaderCell<T>.Grid), grid);
